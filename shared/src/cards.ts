...
export const CARDS: Record<string, CardDef> = {
  footman: {
    id: 'footman', name: 'Footman', type: 'troop', cost: 3, color: 0x8d6e63,
    hp: 700, damage: 80, hitSpeed: 1.1, range: 1.2, moveSpeed: 1.0, targets: 'ground', count: 1,
  },
  archers: {
    id: 'archers', name: 'Archers', type: 'troop', cost: 3, color: 0x66bb6a,
  ...
  ratpack: {
    id: 'ratpack', name: 'Rat Pack', type: 'troop', cost: 2, color: 0x90a4ae,
    hp: 80, damage: 55, hitSpeed: 1.1, range: 1.0, moveSpeed: 1.4, targets: 'ground', count: 3,
  },
  sharpshooter: {
    id: 'sharpshooter', name: 'Sharpshooter', type: 'troop', cost: 4, color: 0xef5350,
    hp: 340, damage: 110, hitSpeed: 1.0, range: 6.0, moveSpeed: 1.0, targets: 'both', count: 1,
  },
  blademaster: {
    id: 'blademaster', name: 'Blademaster', type: 'troop', cost: 4, color: 0xab47bc,
  ...
  volley: {
    id: 'volley', name: 'Volley', type: 'spell', cost: 3, color: 0x26c6da,
