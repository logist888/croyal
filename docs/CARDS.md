...
| Colossus | troop | 6 | 2200 | 130 | 1.5s | 1.2 | 0.7 | ground | Tank, **targets buildings only** |
...
| Bomb Thrower | troop | 4 | 240 | 130 | 1.3s | 4.5 | 1.0 | ground | **Splash** (radius 1.5) |
| Bastion | building | 5 | 700 | 90 | 0.9s | 5.5 | — | ground | Defensive, 30s lifetime |
| Meteor | spell | 5 | — | 360 | — | r 2.5 | — | area | Burst AoE on a point |
