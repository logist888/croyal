 ...
 */
import pg from 'pg';
import { DEFAULT_TRIO, TRIO_SIZE, type PlayerProfile, type Clan, type ClanMember, type ChestSlot } from '@croyal/shared';
...
export class Db {
  ...
  upsertUser(u: PlayerProfile): void {
    this.run(
      `INSERT INTO users (id, telegram_id, nickname, language, trophies, wins, losses, gold, gems, xp, deck, trio, starter_boxes_opened, cards, chests, clan_id, created_at)
       ...
       ON CONFLICT (id) DO UPDATE SET
         ...
         deck=$11::jsonb, trio=$12::jsonb, starter_boxes_opened=$13, cards=$14::jsonb, chests=$15::jsonb, clan_id=$16`,
      [u.id, u.telegramId, u.nickname, u.language, u.trophies, u.wins, u.losses, u.gold, u.gems, u.xp,
        JSON.stringify(u.deck), JSON.stringify(u.trio), u.starterBoxesOpened, JSON.stringify(u.cards), JSON.stringify(u.chests), u.clanId, u.createdAt],
    );
  }
